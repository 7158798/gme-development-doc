  ...
  <body>
  	<form id="formobj" action="${ctx}/bus/g_currency/update" name="formobj" method="post" class="form-horizontal">
 		...
 		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input name="g_currency.currency_sn" value="${item.currency_sn}" class="inputxt" datatype="n1-8"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
 		...
 		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input name="g_currency.enable_time" value="${item.enable_time}" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
	        ...
	        <div class="controls">
		        <c:if test="${item.is_token == 0}">
		        	<input name="g_currency.is_token" value="0" class="inputxt" datatype="n1-1"  type="text">
		        </c:if>
		        <c:if test="${item.is_token == 1}">
		        	<input name="g_currency.is_token" value="1" class="inputxt" datatype="n1-1"  type="text">
		        </c:if>
	        </div>
      	</div>
 		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input name="g_currency.operator_uid" value="${item.operator_uid}" class="inputxt"  datatype="*1-36"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
 		...
 		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input name="g_currency.currency_config_id" value="${item.currency_config_id}" class="inputxt"  datatype="*1-36"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">充值/提现(0000四位)：00-前两位表示是否充值;00-后两位表示是否提现;其中01表示是;02表示否;<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_currency.is_open" value="${item.is_open}" class="inputxt"  datatype="n4-4"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
	        ...
	        <div class="controls">
		         <%-- <c:if test="${item.is_enable == 1}">
		         	<input name="g_currency.is_enable" value="1" class="inputxt" datatype="n1-1"  type="text">
		         </c:if>
		         <c:if test="${item.is_enable == 2}">
		         	<input name="g_currency.is_enable" value="2" class="inputxt" datatype="n1-1"  type="text">
		         </c:if> --%>
		         <input name="g_currency.is_enable" value="${item.is_enable}" class="inputxt" datatype="n1-1"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">发行量<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_currency.supply" value="${item.supply}" class="inputxt"  datatype="n1-18"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">流通总量<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_currency.circulation" value="${item.circulation}" class="inputxt"  datatype="n1-18"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
 		...
 		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input name="g_currency.version" value="${item.version}" class="inputxt"  datatype="n1-8"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">创建时间格式:yyyy-MM-dd HH:ss:mm<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_currency.create_time" value="${item.create_time}" class="Wdate"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">更新时间格式:yyyy-MM-dd HH:ss:mm<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_currency.updated_time" value="${item.updated_time}" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  type="text">
	        </div>
      	</div>
