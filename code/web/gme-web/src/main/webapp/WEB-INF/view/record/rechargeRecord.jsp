...
<div id="siteNoty" class="notification-box"><div class="noty_message">【重要通知】： <a id="siteNotyCon" href="/article/16451" >gate.io充值量子链(QTUM)赢取QTUM大奖活动公告</a><a class="close pull-right" href=javascript:;></a></div></div><div class="header clearfix">
    <div class="top-up">
        <div class="top-con">
            <ul class="topprice">
				<li> BTC/CNY : ￥ <span class="topnum">54665.73</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> ETH/CNY : ￥ <span class="topnum">4593.09</span><i class="icon-arrow-down">&darr;</i> </li>
                <li> LTC/CNY : ￥ <span class="topnum">877.98</span><i class="icon-arrow-down">&darr;</i> </li>
                <li> QTUM/CNY : ￥ <span class="topnum">105.17</span><i class="icon-arrow-down">&darr;</i> </li>
            </ul>
            <div class="qqtel">
                                ...
                                <div class="tier-info" id="tierMenu">
                                    <ul>
                                        ...
                                        <li>升级还需要 <strong>3.0</strong> BTC 或者
                                            <strong>163997</strong> CNY 30天交易量
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<div class="m_title"><h4>最近充值记录</h4></div>
<div class="sectioncont funds-dtl">
	<table class='sf-grid table-inacc table-inacc-head'>
		<thead>
		<tr>
			<th><b>单号</b></th>
			<th align='left'><b>时间</b></th>
			<th align='right'><b>金额</b></th>
			<th align='right'><b>转账ID</b></th>
			<th align='right'><b>确认个数</b></th>
			<th align='right'><b>状态</b></th>
		</tr>
		</thead>
	</table>
	<div class="table-scroll">
		<table class='sf-grid table-inacc table-inacc-body'>
			<tbody>
							<tr class="table-empty">
					<td style="text-align: center"><p><i>i</i>暂无充值记录</p></td>
				</tr>
			</tbody>
		</table>
	</div>
...
<br><br>
<div id="servTime">当前服务器时间: <b>2018-05-21 18:26:01 UTC+8</b></div>
<script>
	var $tableScroll=$(".table-scroll"), tableH=$(".table-inacc").find("tbody").height(), scrollBoxH=document.body.clientHeight-250;
	...
	$("td:contains('已完成')").css("color","#008069");
	$("td:contains('已经取消')").css("color","#888");
	$("td:contains('已经退回')").css("color","#a00");
	$("td:contains('等待')").css("color","#dc9a00");
	$("td:contains('正在审核')").css("color","#f60");
	$("td:contains('正在处理')").css("color","#0086b3");
</script>
...
<div class="footer">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">132624304</span> </span>
                <span> BTC : ฿<span id="btcAll">655</span> </span>
                <span> LTC : Ł<span id="ltcAll">2380</span> </span>
                <span> ETH : E<span id="ethAll">31814</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:7.007ms - cnst:0.9;14:0.3;12:0.4;13:1.2; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#usdtAll").text(toThousands(132624304));
    $("#btcAll").text(toThousands(655));
    $("#ltcAll").text(toThousands(2380));
    $("#ethAll").text(toThousands(31814));
