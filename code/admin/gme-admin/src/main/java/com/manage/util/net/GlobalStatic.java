...
public interface GlobalStatic {
	 ...
	 * Spring加密属性文件的密钥
	 */
	public static final String SPRING_ENCRYPT_KEY = "biznest";
	 ...
	 * 项目根据经
	 */
	public static final String ROOT_PATH = ConfigUtil.get("rootPath");
	/**
	 * 支付名称
	 */
...
//			.get("AgentID"));
	...
	public static final String MATERIAL_URL_PREFIX = ConfigUtil.get("material.url.prefix");
}
